    ...
    <div class="h-auto px-6 pb-8 mx-auto text-sm text-gray-900 bg-gray-200 mentions container-inner">
      <h2 class="py-4 mb-4 text-3xl font-semibold tracking-wider text-center"> -Mentions légales-</h2>
        ...
        <div class="mb-6 text-base">
          ...
          <div class="mb-6">
            <p>L’utilisateur du site web www.pantaloni-associes.com reconnaît avoir pris connaissance des présentes conditions d’utilisation du site et s’engage à les respecter.<br />
            Pantaloni &amp; Associés ne saurait être tenue pour responsable des dommages directs ou indirects qui pourraient résulter de l’accès au site ou de l’utilisation du site et/ou de ces informations, y compris l’inaccessibilité, les pertes de données, détériorations, destructions ou virus qui pourraient affecter l’équipement informatique de l’utilisateur et/ou de la présence de virus sur son site.<br />
            Bien que Pantaloni &amp; Associés s’efforce de fournir un contenu fiable sur son site, il ne garantit pas que son contenu soit exempt d’inexactitudes ou d’omissions et ne saurait être tenu pour responsable des erreurs ou omissions, d’une absence de disponibilité des informations et des services. Pantaloni &amp; Associés se réserve à tout moment et sans préavis le droit d’apporter des améliorations et/ou des modifications au contenu de son site. En conséquence, l’utilisateur reconnaît se servir de ses informations sous sa responsabilité exclusive.</p>
          </div>
          ...
          <div class="mb-6">
            ...
            <ol>
              <li>Si vous utilisez le navigateur Internet Explorer Dans Internet Explorer, cliquez sur le bouton « Outils », puis sur « Options Internet ». Sous l’onglet Général, sous « Historique de navigation », cliquez sur « Paramètres ». Cliquez sur le bouton « Afficher les fichiers ». Cliquez sur l’en-tête de colonne « Nom pour trier tous les fichiers dans l’ordre alphabétique », puis parcourez la liste jusqu’à ce que vous voyez des fichiers commençant par le préfixe « Cookie » (tous les cookies possèdent ce préfixe et contiennent habituellement le nom du site Web qui a créé le cookie). Sélectionnez le ou les cookie(s) que vous refusez et supprimez-les. Fermez la fenêtre qui contient la liste des fichiers, puis cliquez deux fois sur « OK » pour retourner dans Internet Explorer.</li>
              <li>Si vous utilisez le navigateur Firefox Allez dans l’onglet « Outils » du navigateur puis sélectionnez le menu « Options ». Dans la fenêtre qui s’affiche, choisissez « Vie privée » et cliquez sur « Affichez les cookies ». Repérez les fichiers que vous refusez. Sélectionnez-les et supprimez-les.</li>
              <li>Si vous utilisez le navigateur Safari Dans votre navigateur, choisissez le menu « Édition Préférences ». Cliquez sur « Sécurité ». Cliquez sur « Afficher les cookies ». Sélectionnez les cookies que vous refusez et cliquez sur « Effacer » ou sur « Tout effacer ». Après avoir supprimé les cookies, cliquez sur « Terminé ».</li>
              ...
              En cas de refus des témoins de connexions, certains services peuvent ne plus être accessibles.</li>
            </ol>
          </div>
      </div>
    </div>
