<template>
    <div class="min-h-screen border-b-2 border-gray-300" >
      <h2 class="py-4 text-3xl font-semibold tracking-wider text-center uppercase" id="equipe">L'équipe</h2>
        <div class="items-center justify-between lg:flex">
        <div class="w-full lg:w-1/2">
          <img src="~assets/img/plumes.jpg" alt="plume" class="px-3 py-6 mx-auto sm:mx-0" />
        </div>
        ...
        <br>
        Adipisicing dolor sint veniam aliquip. Nulla consequat enim quis quis ea deserunt veniam pariatur adipisicing nulla exercitation et magna aliquip. Labore laborum labore velit esse aliqua excepteur irure Lorem cupidatat sit adipisicing sint sint deserunt.</p>
        </div>
      </div>
    </div>
</template>
