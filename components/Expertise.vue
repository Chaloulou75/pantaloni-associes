<template>
    <div class="min-h-screen text-white bg-gray-900 border-b-2 border-gray-300" >
      <h2 class="py-4 text-3xl font-semibold tracking-wider text-center uppercase" id="expertise">Expertise</h2>
