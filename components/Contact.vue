      ...
      <div class="lg:flex">
        ...
        <div class="flex justify-start w-full px-2 text-gray-700 lg:px:8 lg:justify-center lg:w-1/2">
          <div class="px-12 py-4 my-4 space-y-3 rounded-lg lg:my-0">
            ...
            <p class="flex items-center text-base lg:text-lg"><svg class="inline-block w-6 h-6 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207"></path></svg>
              email@email.com
            </p>
            <p class="flex items-center text-base lg:text-lg">
              <span class="mr-4 font-semibold"> Fax: </span> 012345678
            </p>
          </div>
        </div>
      </div>
