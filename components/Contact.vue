      ...
      <div class="justify-around lg:flex">
        ...
        <div class="flex justify-start w-full px-2 text-gray-100 lg:px:8 lg:justify-center lg:w-1/3">
          <div class="px-12 py-4 rounded-lg">
              ...
              <p class="mt-4 ml-10 text-lg text-gold lg:text-2xl">Pantaloni &amp; Associés | Avocats</p>
        ...
        <div class="flex justify-start w-full px-2 text-gray-100 lg:justify-center lg:w-1/3">
