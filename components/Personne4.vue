<template>
  <div class="h-auto bg-yellow-300">

    <h2 class="py-2 mb-6 text-5xl font-medium text-center text-gray-800 hover:text-gray-600 lg:hidden">Laura Doe</h2>
    ...
    <div class="items-center justify-between lg:flex">
      ...
      <div class="flex flex-col justify-between w-full px-6 lg:w-1/2">
           <h2 class="hidden py-2 mb-6 text-5xl font-medium text-center text-gray-700 hover:text-gray-600 lg:block">Laura Doe</h2>
