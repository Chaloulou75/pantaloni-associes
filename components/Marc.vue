<template>
  <div class="h-auto">
    ...
    <h2 class="py-2 mb-6 text-5xl font-medium text-center text-gray-700 hover:text-gray-600 lg:hidden">Marc Pantaloni</h2>
    <div class="py-2 line-1 lg:hidden"></div>

    <div class="flex-row-reverse items-center justify-between lg:flex">
      ...
      <div class="flex flex-col justify-between w-full px-6 py-4 lg:w-1/2">
           <h2 class="hidden py-2 mb-6 text-5xl font-medium text-center text-gray-700 hover:text-gray-600 lg:block">Marc Pantaloni</h2>
